...
import { Heart, Check, ArrowRight, Download, TrendingUp } from "lucide-react";
import Link from "next/link";

export default function FetalMovementTrackerPage() {
  const benefits = [
    "Comprehensive movement tracking dashboard",
    "Visual patterns and trends over time",
    "Movement intensity and frequency insights",
    "Compare daily patterns for anomalies",
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Advanced analytics to understand your baby's movement patterns and stay informed throughout your pregnancy.
            </p>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-4xl font-black text-gray-900 mb-12">Tracking Features</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {benefits.map((benefit, i) => (
              <div key={i} className="flex gap-4 p-6 bg-pink-50/50 rounded-xl border border-pink-100 hover:border-[#FF5A6E] transition-colors">
                <TrendingUp size={24} className="text-[#FF5A6E] flex-shrink-0 mt-1" />
      ...
      <section className="py-20 px-6 bg-[#FFFBFC]">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            {[
              { num: 1, title: "Daily Tracking", desc: "Record your baby's movements each day" },
              { num: 2, title: "Automatic Analysis", desc: "Our system analyzes patterns in real-time" },
              { num: 3, title: "View Insights", desc: "See charts, graphs, and detailed analytics" },
              { num: 4, title: "Share Data", desc: "Export reports to discuss with your doctor" }
            ].map((step) => (
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl bg-gradient-to-r from-[#FF5A6E]/10 to-pink-50 rounded-2xl p-12 border border-pink-200 text-center">
          <h2 className="text-3xl font-black text-gray-900 mb-4">Understand Your Baby's Patterns</h2>
          <p className="text-gray-600 mb-8 text-lg">Advanced tracking with insights you can trust</p>
