...
import { Heart, Check, ArrowRight, Download, Bell } from "lucide-react";
import Link from "next/link";

export default function PregnancyRemindersPage() {
  const benefits = [
    "Customizable reminder notifications for kick counting",
    "Gentle push notifications at your preferred times",
    "Never forget your daily tracking routine",
    "Smart reminders based on your schedule",
    "Optional daily wellness check-ins"
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Stay on top of your kick counting with smart, personalized reminders that fit your daily routine.
            </p>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-4xl font-black text-gray-900 mb-12">Key Features</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {benefits.map((benefit, i) => (
              <div key={i} className="flex gap-4 p-6 bg-pink-50/50 rounded-xl border border-pink-100 hover:border-[#FF5A6E] transition-colors">
                <Bell size={24} className="text-[#FF5A6E] flex-shrink-0 mt-1" />
      ...
      <section className="py-20 px-6 bg-[#FFFBFC]">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            {[
              { num: 1, title: "Set Your Preferences", desc: "Choose reminder times that work best for you" },
              { num: 2, title: "Receive Notifications", desc: "Get gentle push notifications on your schedule" },
              { num: 3, title: "Quick Access", desc: "Tap the notification to open the counter instantly" },
              { num: 4, title: "Build Consistency", desc: "Stay consistent with your tracking routine" }
            ].map((step) => (
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl bg-gradient-to-r from-[#FF5A6E]/10 to-pink-50 rounded-2xl p-12 border border-pink-200 text-center">
          <h2 className="text-3xl font-black text-gray-900 mb-4">Never Miss a Kick Again</h2>
          <p className="text-gray-600 mb-8 text-lg">Enable reminders and stay consistent with tracking</p>
